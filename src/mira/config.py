...
class ReviewConfig(BaseModel):
    ...
    # One-shot PR comments when a review starts and when it finishes with
    # zero findings — visible activity for otherwise silent round-2+ runs.
    chat_updates: bool = True
